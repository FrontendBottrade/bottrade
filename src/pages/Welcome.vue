    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
            <nav class="flex items-center justify-end gap-4">
                <router-link to="/interface/dashboard" class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
                    Dashboard
                </router-link>
                <router-link to="/auth/login" class="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]">
                    Log in
                </router-link>
                <router-link to="/auth/register" class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
                    Register
                </router-link>
            </nav>
        </header>
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Bienvenue sur votre application Vue.js !</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Ce projet est une Single Page Application moderne construite avec <b>Vue.js</b> et <b>Vite</b>.<br />
                        Commencez par explorer le dashboard ou connectez-vous pour accéder à toutes les fonctionnalités.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li class="relative flex items-center gap-4 py-2">
                            ...
                            <span>
                                Lire la <a href="https://vuejs.org/guide/introduction.html" target="_blank" class="ml-1 inline-flex items-center space-x-1 font-medium text-[#42b883] underline underline-offset-4 dark:text-[#42b883]">documentation Vue.js</a>
                            </span>
                        </li>
                        <li class="relative flex items-center gap-4 py-2">
                            <span class="relative bg-white py-1 dark:bg-[#161615]">
                            ...
                            <span>
                                Découvrir <a href="https://vitejs.dev/guide/" target="_blank" class="ml-1 inline-flex items-center space-x-1 font-medium text-[#646cff] underline underline-offset-4 dark:text-[#646cff]">Vite</a> pour un développement ultra-rapide
                            </span>
                        </li>
                    </ul>
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="https://vuejs.org/" target="_blank" class="inline-block rounded-sm border border-[#42b883] bg-[#42b883] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#42b883] hover:bg-[#36876b] dark:border-[#42b883] dark:bg-[#42b883] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white">
                                Site officiel Vue.js
                            </a>
                        </li>
                        <li>
                            <a href="https://vitejs.dev/" target="_blank" class="inline-block rounded-sm border border-[#646cff] bg-[#646cff] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#646cff] hover:bg-[#4546a7] dark:border-[#646cff] dark:bg-[#646cff] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white">
                                Site officiel Vite
                            </a>
                        </li>
                    </ul>
