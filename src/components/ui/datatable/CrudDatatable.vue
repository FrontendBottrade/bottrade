<template>
    <div>
        <div class="card scroll-container w">
            <Toolbar class="mb-6">
                <template #start>
...
import Select from 'primevue/selectbutton'; // Ou Dropdown si t'utilises dropdown
import IconField from 'primevue/iconfield';
import InputIcon from 'primevue/inputicon';
import Textarea from 'primevue/textarea';
import 'primeicons/primeicons.css'; // Les icônes de PrimeVue
...
.scroll-container {
  width: 100%;
  max-height: 200px; /* Définir une hauteur maximale selon vos besoins */
